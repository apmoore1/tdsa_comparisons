...
if __name__ == '__main__':
    ...
    parser.add_argument("--in_target_order", action="store_true")
    ...
    # Add unique target IDs
    train_dataset.add_unique_key('targets', 'target_id')
    test_dataset.add_unique_key('targets', 'target_id')
    ...
    for dataset in datasets:
        ...
        if args.in_target_order:
            keys_not_to_order=['pos_tags', 'tokenized_text', 
                               'category_sentiments', 'categories']
            dataset.re_order(keys_not_to_order=keys_not_to_order)
        if args.task == 'sentiment':
